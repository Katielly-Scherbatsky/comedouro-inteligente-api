...
@Module({
  imports: [
    TypeOrmModule.forRoot({
      ...
      database: 'postgres',
      entities: [Alarme, Alimentacao, Comedouro, Fornecedor, Pedido, Pet,Produto, ProdutoFornecedor, Usuario],
      synchronize: false,
    }),
    TypeOrmModule.forFeature([Alarme, Alimentacao, Comedouro,  Fornecedor, Pedido, Pet, Produto, ProdutoFornecedor, Usuario ]),
    AlarmeModule,
    AlimentacaoModule,
    ComedouroModule,
    FornecedorModule,
